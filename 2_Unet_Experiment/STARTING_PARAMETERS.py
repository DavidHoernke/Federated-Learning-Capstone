...
#Number of clients in the federated setup
NUM_CLIENTS = 8

#Client dropout
CLIENT_PARTICIPATION_FRACTION = 0.8 #Represents what fraction of clients will be trained and used for eval each round
